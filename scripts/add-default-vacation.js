  ...
  try {
    ...
    for (const user of users) {
      ...
      if (!balance) {
        ...
        created++;
      } else if (balance.vacation_hours === 0 || balance.vacation_hours === null) {
    ...
    console.log(`✓ Set all users to ${DEFAULT_VACATION_HOURS} vacation hours (${DEFAULT_VACATION_HOURS / 8} days)`);
    process.exit(0);
  } catch (error) {
