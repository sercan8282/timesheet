  ...
  async (req, res) => {
    try {
      ...
      await db.run(
       ...
       WHERE id = ?`,
        [
          element_type !== undefined ? element_type : currentElement.element_type,
          label !== undefined ? label : (currentElement.label || null),
          content !== undefined ? content : (currentElement.content || null),
          image_path,
          position_order !== undefined ? position_order : (currentElement.position_order || 0),
          font_size !== undefined ? font_size : (currentElement.font_size || 14),
          font_color !== undefined ? font_color : (currentElement.font_color || "#000000"),
          font_weight !== undefined ? font_weight : (currentElement.font_weight || "normal"),
          font_family !== undefined ? font_family : (currentElement.font_family || null),
          image_align !== undefined ? image_align : (currentElement.image_align || "left"),
          image_width !== undefined ? image_width : (currentElement.image_width || 150),
          image_height !== undefined ? image_height : (currentElement.image_height || 0),
          calculation_formula !== undefined ? calculation_formula : (currentElement.calculation_formula || null),
          text_align_h !== undefined ? text_align_h : (currentElement.text_align_h || "left"),
          elementId,
        ]
      );
