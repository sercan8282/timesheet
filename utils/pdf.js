  ...
  return new Promise((resolve, reject) => {
    try {
      ...
      doc
        .fontSize(10)
        .fillColor("#000000")
        .text(`Employee: ${userName}`, { align: "left" });
      ...
      doc
        .rect(40, tableTop, totalColWidth + 20, 20)
        .fillAndStroke(rgb.r, rgb.g, rgb.b, rgb.r, rgb.g, rgb.b);
      ...
      headers.forEach((header) => {
        doc.text(header.text, xPos + 3, tableTop + 5, {
      ...
      timesheets.forEach((timesheet, index) => {
        ...
        if (index % 2 === 0) {
          doc
            .rect(40, yPos, totalColWidth + 20, 16)
        ...
        const rowData = [
          {
            text: timesheet.week_number.toString(),
            width: colWidths.weekNumber,
          },
          {
            text: (timesheet.ritnumber || "-").toString(),
            width: colWidths.ritnumber,
          },
          ...
          {
            text: timesheet.total_hours.toFixed(2),
            width: colWidths.totalHours,
          },
        ...
        rowData.forEach((cell) => {
          doc.text(cell.text, xPos + 3, yPos + 2, {
            width: cell.width - 6,
            align: "center",
            fontSize: 7,
          });
      ...
      doc
        .fontSize(7)
        .fillColor("#999999")
        .text(`Generated on ${new Date().toLocaleString()}`, 40, footerY, {
          align: "center",
          width: pageWidth,
        });
